  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow dark:bg-gray-800 dark:text-gray-100">
      ...
      <div className="space-y-4">
        {/* Removed College Name field as requested */}

        <div>
          <label className="block text-gray-700 text-sm font-bold mb-2 dark:text-gray-300" htmlFor="notifications">
            Attendance Notifications
          </label>
          <select
            id="notifications"
            className="shadow border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline dark:bg-gray-900 dark:border-gray-600 dark:text-gray-200"
          >
        ...
        <button className="bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-800">
          Save Settings
        </button>
      </div>
    </div>
